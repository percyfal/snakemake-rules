...
_output.update({
    ...
    'insert_size_across_reference': "{prefix}.bam.qualimap/raw_data_qualimapReport/insert_size_across_reference.txt",
    'insert_size_histogram': "{prefix}.bam.qualimap/raw_data_qualimapReport/insert_size_histogram.txt",
